...
namespace NLayer.Repository.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        protected readonly AppDbContext _context;//miras alınan classlarda erişşişilmesi için
        private readonly DbSet<T> _dbSet;//ya bu esnada ya constructurda değer ata  sonra hata alırız
        ...
        public IQueryable<T> GetAll()
        {
           ...
           //memorye almasın performanslı olsun
